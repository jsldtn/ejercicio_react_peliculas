// This file is responsible for displaying the top-rated movies
...
export default function TopRated() {
  ...
  useEffect(() => {
    ...
    fetchTopRatedMovies(page)
      ...
      .catch(() => setError("Error al cargar las películas mejor calificadas."))
      .finally(() => setLoading(false));
  }, [page]);

  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Mejor Calificadas</h1>
      {loading ? (
